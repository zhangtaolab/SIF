...
- [x] 05-09-PLAN.md — Write-side fix: canonical context add targets, dual-form upsert self-heal, prune normalization with real-SQL tests (gap closure, CTX-01, CTX-02)
