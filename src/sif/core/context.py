...
class ContextManager:
    ...
    def get_context_for_target(self, target_id: str, context_type: ContextType) -> Context | None:
    ...
    def build_search_context(
        ...
        if collection_ids:
            for collection_id in collection_ids:
                ctx = self._repository.get_by_target(collection_id, ContextType.COLLECTION)
                if ctx:
